...
This **hxlua fork** is licensed under the **MIT License**. See [LICENSE](LICENSE) for details.

**hxlua** is made available under the **MIT License**. Check [LICENSE-hxlua](./LICENSE-hxlua) for more information.
